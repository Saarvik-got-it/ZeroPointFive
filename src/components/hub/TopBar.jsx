...
const hubCategories = ['All', 'Business', 'Startups', 'Technology', 'Leadership', 'Innovation', 'AI'];

export default function TopBar({ searchQuery, setSearchQuery, selectedCategory, setSelectedCategory }) {
  return (
    <div className="sticky top-0 z-40 bg-[#050505]/95 backdrop-blur-xl border-b border-[#FF7A1A]/10">
      <div className="flex items-center gap-4 px-8 py-4">
        ...
        <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-6 py-3 bg-gradient-to-r from-[#FF7A1A] to-[#FF9A3D] rounded-xl text-[#050505] font-semibold hover:shadow-lg hover:shadow-[#FF7A1A]/30 transition-shadow duration-300">
          Search
        </motion.button>
        <motion.button whileHover={{ scale: 1.05 }} className="w-11 h-11 rounded-full bg-gradient-to-br from-[#FF7A1A] to-[#FF9A3D] flex items-center justify-center">
